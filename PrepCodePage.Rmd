...
famer = copy(famer_original)
tracemem(famer) == tracemem(famer_original)
fun = function(x){
  str_sub(x, 3,-3)
}
...
topten_popularity = famer_original %>%    ###trying to figure out how to find top playlists by popularity
  arrange(popularity) %>%
